!  A MC run for the thermodynamical energy, a.u. used
!
!
!-----------------------------------------------------------------------
module m_random
...
!  allows for use of different random generators
  ...
  integer :: MCMAX,MCPRE,MCOUNT
  integer,parameter :: MRAN=10001,ISEED=1820459103
  integer, parameter :: MAKF=10000
  integer :: IRAN,IFRAN,ISEED0,ISEED1,SEED
  real, dimension(MRAN) :: FRAN
  character(40) :: RANDNAME
  REAL(8), private :: B = 4.294967291D9, C=0.0D0
  REAL(8) :: ZBQLIX(43) = (/ 8.001441D7,5.5321801D8, &
...
!       write(*,*)'MCPRE,MCMAX,MAXA=?'
!       read(*,*)MCPRE,MCMAX,MAXA
!       MCPRE=100
!       MCMAX=1000
!       MAXA=100
...
!
      ...
      REAL(8) :: TMPVAR1,DSS,DMM,DHH,DDD
 ...
 !1    FORMAT(//5X,"****WARNING**** You have called routine ZBQLINI more than once. &
 !           I'm ignoring any subsequent calls.",//)
